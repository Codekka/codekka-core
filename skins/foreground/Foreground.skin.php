...
<div class="off-canvas-wrap" data-offcanvas>
		<nav class="top-bar" data-topbar>
						<ul class="title-area">
							<li class="name"><h1><a class="codekka">Codekka</a></h1></li>
		        	...
		        	<form action="<?php $this->text( 'wgScript' ); ?>" id="searchform" class="mw-search">
		            	...
		            	<div class="small-8 columns">
		        			 ...
		        			 <div class="small-4 columns">
		        				<button type="submit" class="button expand"><?php echo wfMessage( 'search' )->text() ?></button>
		        			</div>
		        		</div>
		        	</form>
		        </li>
  ...
  <div class="inner-wrap">
    ...
    <section class="main-section">
		...
		<div class="row">
				...
				<div id="p-cactions" class="large-12 medium-12 columns content-container">
